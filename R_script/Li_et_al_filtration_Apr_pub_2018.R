...
FT_Statistic$Treatment <-mapvalues(FT_Statistic$Treatment, c("T1_.45","T2_.8","T3_1.2", "T4_Sterivex", "T5_PF_.45", "TP5_PF"), 
                                c("0.45MCE","0.8MCE","1.2MCE","0.45Sterivex","PF_0.45MCE","PF"))


#Rename the treatments
FT_DC_original$Treatment <- mapvalues(FT_DC_original$Treatment, c("T1_0.45","T2_0.8","T3_1.2","T4_Sterivex","T5_PF_0.45","TP5_PF"), 
                                                              c("0.45MCE","0.8MCE","1.2MCE","0.45Sterivex","PF_0.45MCE","PF"))

FT_DC$Treatment <- mapvalues(FT_DC$Treatment, c("T1_0.45","T2_0.8","T3_1.2","T4_Sterivex","T5_PF_0.45","TP5_PF"), 
                                      c("0.45MCE","0.8MCE","1.2MCE","0.45Sterivex","PF_0.45MCE","PF"))
...
ggsave("Fig3_FT_boxplot.pdf",path = "July2016_12s_onestep_filtration/Reanalysis_May_2017/Figures/", width = 12, height = 10, units = "in", dpi=500)


# Fig2_DNA concentration --------------------------------------------------
...
DNA_Statistic$Treatment <- mapvalues(DNA_Statistic$Treatment, c("T1_0.45","T2_0.8","T3_1.2","T4_Sterivex","T5_PF_0.45","TP5_PF"), 
                                      c("0.45MCE","0.8MCE","1.2MCE","0.45Sterivex","PF_0.45MCE","PF"))
...
ggsave("Fig2_DC_boxplot.pdf",path = "July2016_12s_onestep_filtration/Reanalysis_May_2017/Figures/", width = 12, height = 10, units = "in", dpi=500)
...
Filtration <- read.csv(file = "July2016_12s_onestep_filtration/Reanalysis_May_2017/AppendixS1_Filtration_12S_OTU_Nov_2017.csv")
...
Filtration_rs_sample$Treatment <- factor(Filtration_rs_sample$Treatment , levels = (c("0.45MCE","0.8MCE","1.2MCE","0.45Sterivex","PF_0.45MCE","PF")))
...
# FigS5_heterogeneity_rep_boxplot_outliers -------------------------------------------------------------------
...
ggsave("FigS5_heterogeneity_rep_boxplot_outliers.jpeg",path = "July2016_12s_onestep_filtration/Reanalysis_May_2017/Figures/", width = 12, height = 10, units = "in", dpi=500)
...
spadeR_Statistic$Treatment <-mapvalues(spadeR_Statistic$Treatment, c("T1","T2","T3", "T4", "T5", "TP5","Umong"), 
                                   c("0.45MCE","0.8MCE","1.2MCE","0.45Sterivex","PF_0.45MCE","PF","Among"))
...
spadeR_all_boxplot <- ggplot(spadeR_all,aes(x=Treatment,y=Estimate))+
                      ...
                      scale_x_discrete(limits=c("0.45MCE","0.8MCE","1.2MCE","0.45Sterivex","PF_0.45MCE","PF","Among"))+
...
NMDS_data.scores_pond$Treatment <- mapvalues(NMDS_data.scores_pond$Treatment, c("T1_0.45","T2_0.8","T3_1.2","T4_Sterivex","T5_PF_0.45","TP5_PF"), 
                                                                              c("0.45MCE","0.8MCE","1.2MCE","0.45Sterivex","PF_0.45MCE","PF"))


NMDS_hull.data_pond$Treatment <- mapvalues(NMDS_hull.data_pond$Treatment, c("T1_0.45","T2_0.8","T3_1.2","T4_Sterivex","T5_PF_0.45","TP5_PF"), 
                                                                              c("0.45MCE","0.8MCE","1.2MCE","0.45Sterivex","PF_0.45MCE","PF"))

NMDS_data.scores_pond$Treatment <- factor(NMDS_data.scores_pond$Treatment , levels = (c("0.45MCE","0.8MCE","1.2MCE","0.45Sterivex","PF_0.45MCE","PF")))


NMDS_hull.data_pond$Treatment <- factor(NMDS_hull.data_pond$Treatment , levels = (c("0.45MCE","0.8MCE","1.2MCE","0.45Sterivex","PF_0.45MCE","PF")))
...
ggsave("Fig5_Horn_NMDS_0.5.pdf",Horn_NMDS,path = "July2016_12s_onestep_filtration/Reanalysis_May_2017/Figures/", width = 12, height = 18, units = "in", dpi=500)
...
NMDS_E1_1 <- NMDS_E1[which(NMDS_E1$Treatment == "0.45MCE"|
                             NMDS_E1$Treatment == "0.8MCE"),]

NMDS_E1_1 <- NMDS_E1[which(NMDS_E1$Treatment == "0.45MCE"|
                             NMDS_E1$Treatment == "1.2MCE"),]

NMDS_E1_1 <- NMDS_E1[which(NMDS_E1$Treatment == "0.8MCE"|
                             NMDS_E1$Treatment == "1.2MCE"),]

NMDS_E1_1 <- NMDS_E1[which(NMDS_E1$Treatment == "0.45MCE"|
                             NMDS_E1$Treatment == "0.45Sterivex"),]

NMDS_E1_1 <- NMDS_E1[which(NMDS_E1$Treatment == "0.45MCE"|
                             NMDS_E1$Treatment == "PF_0.45MCE"),]

NMDS_E1_1 <- NMDS_E1[which(NMDS_E1$Treatment == "PF"|
                             NMDS_E1$Treatment == "PF_0.45MCE"),]

NMDS_E1_1 <- NMDS_E1[which(NMDS_E1$Treatment == "0.45MCE"|
                             NMDS_E1$Treatment == "PF"),]
...
NMDS_E2_1 <- NMDS_E2[which(NMDS_E2$Treatment == "0.45MCE"|
                             NMDS_E2$Treatment == "0.8MCE"),]

NMDS_E2_1 <- NMDS_E2[which(NMDS_E2$Treatment == "0.45MCE"|
                             NMDS_E2$Treatment == "1.2MCE"),]

NMDS_E2_1 <- NMDS_E2[which(NMDS_E2$Treatment == "0.8MCE"|
                             NMDS_E2$Treatment == "1.2MCE"),]

NMDS_E2_1 <- NMDS_E2[which(NMDS_E2$Treatment == "0.45MCE"|
                             NMDS_E2$Treatment == "0.45Sterivex"),]

NMDS_E2_1 <- NMDS_E2[which(NMDS_E2$Treatment == "0.45MCE"|
                             NMDS_E2$Treatment == "PF_0.45MCE"),]

NMDS_E2_1 <- NMDS_E2[which(NMDS_E2$Treatment == "PF"|
                             NMDS_E2$Treatment == "PF_0.45MCE"),]

NMDS_E2_1 <- NMDS_E2[which(NMDS_E2$Treatment == "0.45MCE"|
                             NMDS_E2$Treatment == "PF"),]
...
NMDS_E3_1 <- NMDS_E3[which(NMDS_E3$Treatment == "0.45MCE"|
                             NMDS_E3$Treatment == "0.8MCE"),]

NMDS_E3_1 <- NMDS_E3[which(NMDS_E3$Treatment == "0.45MCE"|
                             NMDS_E3$Treatment == "1.2MCE"),]

NMDS_E3_1 <- NMDS_E3[which(NMDS_E3$Treatment == "0.8MCE"|
                             NMDS_E3$Treatment == "1.2MCE"),]

NMDS_E3_1 <- NMDS_E3[which(NMDS_E3$Treatment == "0.45MCE"|
                             NMDS_E3$Treatment == "0.45Sterivex"),]

NMDS_E3_1 <- NMDS_E3[which(NMDS_E3$Treatment == "0.45MCE"|
                             NMDS_E3$Treatment == "PF_0.45MCE"),]

NMDS_E3_1 <- NMDS_E3[which(NMDS_E3$Treatment == "PF"|
                             NMDS_E3$Treatment == "PF_0.45MCE"),]

NMDS_E3_1 <- NMDS_E3[which(NMDS_E3$Treatment == "0.45MCE"|
                             NMDS_E3$Treatment == "PF"),]
...
NMDS_E4_1 <- NMDS_E4[which(NMDS_E4$Treatment == "0.45MCE"|
                             NMDS_E4$Treatment == "0.8MCE"),]

NMDS_E4_1 <- NMDS_E4[which(NMDS_E4$Treatment == "0.45MCE"|
                             NMDS_E4$Treatment == "1.2MCE"),]

NMDS_E4_1 <- NMDS_E4[which(NMDS_E4$Treatment == "0.8MCE"|
                             NMDS_E4$Treatment == "1.2MCE"),]

NMDS_E4_1 <- NMDS_E4[which(NMDS_E4$Treatment == "0.45MCE"|
                             NMDS_E4$Treatment == "0.45Sterivex"),]

NMDS_E4_1 <- NMDS_E4[which(NMDS_E4$Treatment == "0.45MCE"|
                             NMDS_E4$Treatment == "PF_0.45MCE"),]

NMDS_E4_1 <- NMDS_E4[which(NMDS_E4$Treatment == "PF"|
                             NMDS_E4$Treatment == "PF_0.45MCE"),]

NMDS_E4_1 <- NMDS_E4[which(NMDS_E4$Treatment == "0.45MCE"|
                             NMDS_E4$Treatment == "PF"),]
...
ggplot(Merge_Filtration,aes(x=Treatment,y=Percent_reads,fill=Species))+
            ...
            scale_fill_manual(values=c("firebrick3","green4","blue","orange2","tan4","purple3","gray10","hotpink"))+
            scale_y_continuous(labels=percent)+
            scale_x_discrete(limits=c("0.45MCE","0.8MCE","1.2MCE","0.45Sterivex","PF_0.45MCE","PF"))+
...
ggplot(Merge_Filtration_sub_bio_num,aes(x=Treatment,y=Percent_reads,fill=Species))+
  ...
  scale_fill_manual(values=c("firebrick3","green4","blue","orange2","tan4","purple3","gray10","hotpink"))+
  scale_y_continuous(labels=percent)+
  scale_x_discrete(limits=c("0.45MCE","0.8MCE","1.2MCE","0.45Sterivex","PF_0.45MCE","PF","Bio","Abu"))+
  labs(x="Treatment", y= "Species composition")+theme_bw()+
  theme(text=element_text(size=20),axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1),legend.title = element_text(size=15),legend.text = element_text(size=15))



ggsave("Fig4_relative abundance_bio_num.pdf",path = "July2016_12s_onestep_filtration/Reanalysis_May_2017/Figures/", width = 12, height = 10, units = "in", dpi=500)
...
Filtration_summary_sub_E1 <- Filtration_summary_sub[which(Filtration_summary_sub$Pond == "A"),]
Filtration_summary_sub_E2 <- Filtration_summary_sub[which(Filtration_summary_sub$Pond == "B"),]
Filtration_summary_sub_E3 <- Filtration_summary_sub[which(Filtration_summary_sub$Pond == "C"),]
Filtration_summary_sub_E4 <- Filtration_summary_sub[which(Filtration_summary_sub$Pond == "D"),]
...
ggplot(Filtration_summary, aes(x= Number, y=Reads, colour=Treatment, shape=Treatment))+
  ...
  scale_y_log10(breaks = trans_breaks("log10", function(x) 10^x),
                labels = trans_format("log10", math_format(10^.x)))+
  scale_colour_manual(values=c("firebrick1","green","blue","cyan2","gold","gray10")) +
  geom_smooth(formula= y ~ x,method="lm",se=FALSE, size=1.0, na.rm=TRUE)+
  labs(x="Fish abundance", y="Averaged read counts")+theme_bw()+
  guides(col = guide_legend(ncol = 6, byrow = TRUE))+
  stat_cor(method = "pearson",label.sep = "; ",label.y.npc="centre",label.x=3.8,size=5, hjust = 0,show.legend = FALSE)+
  theme(text=element_text(size=20),legend.position = "bottom")


ggsave("Fig6_Lg_Num_reads.pdf",path ="July2016_12s_onestep_filtration/Reanalysis_May_2017/Figures/", width = 12, height = 10, units = "in", dpi=500)
...
ggplot(Filtration_summary, aes(x= Biomass, y=Reads, colour=Treatment, shape=Treatment))+
  geom_jitter(stat="identity",size=3)+
  facet_wrap(~Pond,ncol=2)+
  scale_x_log10(breaks = trans_breaks("log10", function(x) 10^x),
                labels = trans_format("log10", math_format(10^.x)))+
  ...
  labs(x="Fish biomass (kg)", y="Averaged read counts")+theme_bw()+
  guides(col = guide_legend(ncol = 6, byrow = TRUE))+
  stat_cor(method = "pearson",label.sep = "; ",label.y.npc="centre",label.x=2,size=5, hjust = 0,show.legend = FALSE)+
  theme(text=element_text(size=20),legend.position = "bottom")


ggsave("FigS6_Lg_Bio_reads.jpeg",path ="July2016_12s_onestep_filtration/Reanalysis_May_2017/Figures/", width = 12, height = 10, units = "in", dpi=500)
...
FT_DC_P0 <- FT_DC[which(FT_DC$Treatment !='PF'),]
...
FT_DC_P1 <- FT_DC[which(FT_DC$Treatment =='0.45MCE'|
                        FT_DC$Treatment =='0.8MCE'|
                        FT_DC$Treatment =='1.2MCE'),]
...
FT_DC_P2 <- FT_DC[which(FT_DC$Treatment =='0.45MCE'|
                          FT_DC$Treatment =='0.45Sterivex'),]
...
FT_DC_P3 <- FT_DC[which(FT_DC$Treatment =='0.45MCE'|
                          FT_DC$Treatment =='PF_0.45MCE'),]
...
spadeR_all_with_P0 <- spadeR_all_with[which(spadeR_all_with$Treatment !='PF'),]
...
spadeR_all_with_P1 <- spadeR_all_with[which(spadeR_all_with$Treatment =='0.45MCE'|
                                              spadeR_all_with$Treatment =='0.8MCE'|
                                              spadeR_all_with$Treatment =='1.2MCE'),]
...
spadeR_all_with_P2 <- spadeR_all_with[which(spadeR_all_with$Treatment =='0.45MCE'|
                                              spadeR_all_with$Treatment =='0.45Sterivex'),]
...
spadeR_all_with_P3 <- spadeR_all_with[which(spadeR_all_with$Treatment =='0.45MCE'|
                                              spadeR_all_with$Treatment =='PF_0.45MCE'),]
...
correlation_rep_num_P0 <- correlation_rep_num[which(correlation_rep_num$Treatment !='PF'),]
...
correlation_rep_num_P1 <- correlation_rep_num[which(correlation_rep_num$Treatment =='0.45MCE'|
                                              correlation_rep_num$Treatment =='0.8MCE'|
                                              correlation_rep_num$Treatment =='1.2MCE'),]
...
correlation_rep_num_P4 <- correlation_rep_num[which(correlation_rep_num$Treatment =='0.45MCE'|
                                                      correlation_rep_num$Treatment =='1.2MCE'),]
...
correlation_rep_num_P2 <- correlation_rep_num[which(correlation_rep_num$Treatment =='0.45MCE'|
                                              correlation_rep_num$Treatment =='0.45Sterivex'),]
...
correlation_rep_num_P3 <- correlation_rep_num[which(correlation_rep_num$Treatment =='0.45MCE'|
                                              correlation_rep_num$Treatment =='PF_0.45MCE'),]
...
correlation_rep_bio_P0 <- correlation_rep_bio[which(correlation_rep_bio$Treatment !='PF'),]
...
correlation_rep_bio_P1 <- correlation_rep_bio[which(correlation_rep_bio$Treatment =='0.45MCE'|
                                                      correlation_rep_bio$Treatment =='0.8MCE'|
                                                      correlation_rep_bio$Treatment =='1.2MCE'),]
...
correlation_rep_bio_P4 <- correlation_rep_bio[which(correlation_rep_bio$Treatment =='0.8MCE'|
                                                      correlation_rep_bio$Treatment =='1.2MCE'),]
...
correlation_rep_bio_P2 <- correlation_rep_bio[which(correlation_rep_bio$Treatment =='0.45MCE'|
                                                      correlation_rep_bio$Treatment =='0.45Sterivex'),]
...
correlation_rep_bio_P3 <- correlation_rep_bio[which(correlation_rep_bio$Treatment =='0.45MCE'|
                                                      correlation_rep_bio$Treatment =='PF_0.45MCE'),]
